 ...
 * Public
 */
module.exports = creditSalesInvoice
 ...
 * @public
 */
function creditSalesInvoice(salesInvoice, vatRate) {
  var journal = []
  if (arguments.length === 0 && salesInvoice.trim() === '') {
  ...
  if (arguments[1]) {
    ...
    journal[3] = {
      codes: "443",
      credit: calculator('VAT', arguments[0][2], arguments[1])
    }
