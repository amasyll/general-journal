 ...
 * Public
 */
module.exports = cashPurchaseInvoice
 ...
 * @public
 */
function cashPurchaseInvoice(purchaseInvoice, vatRate) {
  var purchaseDairy = []
  ...
  purchaseDairy[0] = arguments[0][0]
  purchaseDairy[1] = `Suivant la facture N°${arguments[0][3]}`
